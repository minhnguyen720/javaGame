...
public class SpikeLeft extends StaticEntity {

    public SpikeLeft(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.spikeLeft, (int) (x - handler.getGameCamera().getxOffset()),
