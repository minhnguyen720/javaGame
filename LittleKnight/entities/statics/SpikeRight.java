...
public class SpikeRight extends StaticEntity {

    public SpikeRight(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.spikeRight, (int) (x - handler.getGameCamera().getxOffset()),
